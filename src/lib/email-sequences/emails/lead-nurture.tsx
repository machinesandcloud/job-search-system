...
export function LeadNurture3({ unsubscribeUrl }: { unsubscribeUrl: string }) {
  return (
    <Layout preview="Why recruiters can't find your LinkedIn profile." headline="Why recruiters can't find your LinkedIn profile." unsubscribeUrl={unsubscribeUrl}>
      <Text style={p()}>
        LinkedIn has 900 million members. Recruiters search it every day. But the algorithm only surfaces a fraction of profiles for any query. Most people are making three specific mistakes.
      </Text>
      <Section style={{ margin: "20px 0" }}>
        <Step number={1} title="Your headline is too generic">
          Recruiters search by job title. "Creative problem-solver" doesn't appear in anyone's search. "Senior Product Manager in B2B SaaS" does. Your headline is the #1 ranking factor.
        </Step>
