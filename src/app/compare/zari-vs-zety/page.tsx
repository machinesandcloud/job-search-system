        ...
        <div className="relative mx-auto max-w-4xl px-6">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-[var(--brand)]/30 bg-[var(--brand)]/[0.08] p-5">
              <p className="mb-3 text-[11px] font-bold uppercase tracking-wider text-[#4361EE]/70">Zari is better for</p>
              <ul className="space-y-2">
                {[
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-3xl px-6">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg)] p-8">
            <p className="mb-2 text-[11px] font-bold uppercase tracking-wider text-[#4361EE]">Honest verdict</p>
