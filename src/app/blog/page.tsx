...
const POSTS = [
  ...
  // Wave 53
  {
    ...
    excerpt: "Medicine, mining, finance, law, and tech — the highest paid roles in Australia with real AUD salary data from SEEK, ABS, and Hays. With negotiation guidance for each sector.",
    tag: "Salary",
    readTime: "10 min read",
    date: "June 2025",
    accent: "#D97706",
  },
  {
    ...
    excerpt: "A four-step framework for building a 1-year, 3-year, and 5-year career plan that actually works — with a template and real examples for experienced professionals and career changers.",
    tag: "Career Strategy",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#7C3AED",
  ...
  {
    slug: "management-interview-questions",
    title: "Management Interview Questions 2025 — 30 Questions + Strong Answers",
    excerpt: "The most common management interview questions with strong answer frameworks — covering leadership style, underperformers, team building, conflict, managing up, and self-awareness.",
    tag: "Interview Prep",
    readTime: "10 min read",
    date: "June 2025",
    accent: "#0D7182",
  ...
  {
    slug: "how-to-get-a-job-in-dubai",
    title: "How to Get a Job in Dubai 2025 — Complete Guide for Expats",
    excerpt: "Visa types (Employment Visa, Green Visa, Freelance Permit), top job boards, AED salary benchmarks, and CV format tips for finding work in Dubai as an expat.",
    tag: "Job Search",
    readTime: "10 min read",
    date: "June 2025",
    accent: "#D97706",
  },
  {
    ...
    excerpt: "ATS impact, recruiter preference, and when each resume format is the right choice in 2025. Spoiler: the functional format is largely obsolete. Here's what to use instead.",
    tag: "Resume",
    readTime: "7 min read",
    date: "June 2025",
    accent: "#0D7182",
  ...
  {
    slug: "best-tech-companies-to-work-for",
    title: "Best Tech Companies to Work For 2025 — Pay, Culture & Career Growth",
    excerpt: "Ranked by total compensation, career growth, and culture — from FAANG to the top high-growth startups. What each company is actually like to work at in 2025.",
    tag: "Career Strategy",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#059669",
  ...
  {
    slug: "how-to-use-linkedin-to-find-a-job",
    title: "How to Use LinkedIn to Find a Job 2025 — Complete Guide",
    excerpt: "Profile settings, search strategy, recruiter outreach, and Easy Apply tactics — everything that actually works on LinkedIn for job seekers in 2025. What to do and what wastes your time.",
    tag: "LinkedIn",
    readTime: "9 min read",
    date: "June 2025",
    accent: "#0A66C2",
  ...
  {
    slug: "how-to-get-a-job-abroad",
    title: "How to Get a Job Abroad 2025 — Complete International Job Search Guide",
    excerpt: "The best countries for skilled workers, visa routes, resume adaptation for international applications, and the job boards that work for international candidates.",
    tag: "Job Search",
    readTime: "10 min read",
    date: "June 2025",
    accent: "#0D7182",
  },
  {
    ...
    title: "How to Write a Personal Statement 2025 — Examples for CV & Jobs",
    excerpt: "A four-part framework for writing a CV personal statement that gets read — with real before/after examples for experienced professionals, graduates, and career changers.",
    tag: "Resume",
    readTime: "7 min read",
    date: "June 2025",
    accent: "#D97706",
  },
  {
    ...
    excerpt: "The best WFH jobs by salary and required skills, the remote job boards with real listings, and how to compete for remote roles when everyone is applying.",
    tag: "Remote Work",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#059669",
  ...
  // Wave 54
  {
    ...
    title: "What Is a Good ATS Score? Resume Scoring Explained (2025)",
    excerpt: "ATS scores explained — what the number means, what score actually gets callbacks, and the specific changes that move a resume from 60% to 85%+.",
    tag: "Resume",
    readTime: "7 min read",
    date: "June 2025",
    accent: "#059669",
  },
  {
    ...
    title: "How Long Should a Resume Be in 2025? One Page vs Two Page",
    excerpt: "The one-page vs two-page debate settled with data — length by experience level, what to cut, and the one exception where three pages is acceptable.",
    tag: "Resume",
    readTime: "6 min read",
    date: "June 2025",
    accent: "#0D7182",
  ...
  {
    slug: "should-i-use-chatgpt-to-write-my-resume",
    title: "Should I Use ChatGPT to Write My Resume? (2025 Answer)",
    excerpt: "ChatGPT can't score your resume against a JD, doesn't know which keywords ATS systems weight, and produces undifferentiated output. Here's what AI to use instead.",
    tag: "Resume",
    readTime: "7 min read",
    date: "June 2025",
    accent: "#7C3AED",
  },
  {
    ...
    title: "Is LinkedIn Premium Worth It in 2025? Honest Breakdown",
    excerpt: "LinkedIn Premium feature-by-feature analysis — InMail, Who Viewed Your Profile, job insights, and AI tools. Worth it for active job seekers; not for most others.",
    tag: "LinkedIn",
    readTime: "7 min read",
    date: "June 2025",
    accent: "#0A66C2",
  ...
  {
    slug: "tech-layoff-survival-guide",
    title: "Tech Layoff Survival Guide — What to Do in the First 30 Days (2025)",
    excerpt: "The 4-phase recovery timeline after a tech layoff — from day-one logistics to active search. Severance negotiation, LinkedIn post script, and the resume move most layoff victims miss.",
    tag: "Job Search Strategy",
    readTime: "9 min read",
    date: "June 2025",
    accent: "#7C3AED",
  },
  {
    ...
    title: "First 90 Days at a New Job — The 30-60-90 Day Plan (2025)",
    excerpt: "A three-phase 30-60-90 day plan for any new role — what to prioritize in each phase, how to build trust fast, and the mistakes that hurt new hires in the first quarter.",
    tag: "Career Strategy",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#059669",
  ...
  {
    slug: "how-to-get-into-product-management",
    title: "How to Get Into Product Management 2025 — Complete Transition Guide",
    excerpt: "Five paths into PM — internal transfer, APM programs, startup PM, MBA route, and PM-adjacent roles. What backgrounds transition best and how to build a portfolio without prior PM experience.",
    tag: "Career Change",
    readTime: "10 min read",
    date: "June 2025",
    accent: "#0D7182",
  },
  {
    ...
    excerpt: "CS degree vs bootcamp vs self-taught — costs, timelines, and employer signal for each path. Which languages to learn first and how to land your first SWE job.",
    tag: "Career Change",
    readTime: "10 min read",
    date: "June 2025",
    accent: "#059669",
  ...
  {
    slug: "how-many-jobs-to-apply-per-day",
    title: "How Many Jobs Should I Apply to Per Day? 2025 Data-Backed Answer",
    excerpt: "5–15 targeted applications per week beats 50 generic ones. The data on callback rates by volume and quality — and how to diagnose which part of your funnel to fix.",
    tag: "Job Search",
    readTime: "6 min read",
    date: "June 2025",
    accent: "#0D7182",
  ...
  {
    slug: "how-long-does-it-take-to-find-a-job",
    title: "How Long Does It Take to Find a Job in 2025?",
    excerpt: "Median job search timelines by level — from entry-level (3–6 months) to C-suite (6–12 months). The specific factors that make searches faster or longer.",
    tag: "Job Search",
    readTime: "7 min read",
    date: "June 2025",
    accent: "#7C3AED",
  },
  {
    ...
    excerpt: "Every resume section explained — what to include, how to write it, and what to leave out. Contact info, professional summary, experience bullets, skills, education, and more.",
    tag: "Resume",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#059669",
  ...
  {
    slug: "how-to-get-a-job-in-germany",
    title: "How to Get a Job in Germany as a Foreigner 2025 — Complete Guide",
    excerpt: "EU Blue Card requirements, German CV format (photo, personal details, tabular layout), best job boards (StepStone, XING), and AED salary benchmarks.",
    tag: "Job Search",
    readTime: "9 min read",
    date: "June 2025",
    accent: "#DD0000",
  ...
  {
    slug: "highest-paying-jobs-singapore",
    title: "Highest Paying Jobs in Singapore 2025 — Salaries by Role and Industry",
    excerpt: "The highest-paying roles in Singapore by sector — SGD salaries, Employment Pass thresholds, tax advantages, and how Singapore compares to US and UK post-tax.",
    tag: "Salary",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#EF4444",
  ...
  {
    slug: "highest-paying-jobs-dubai",
    title: "Highest Paying Jobs in Dubai 2025 — Salaries in AED and USD",
    excerpt: "Dubai's highest-paying roles with 0% income tax — AED salaries, USD equivalents, the real post-tax advantage vs US/UK/Germany, and UAE visa requirements.",
    tag: "Salary",
    readTime: "8 min read",
    date: "June 2025",
    accent: "#D97706",
