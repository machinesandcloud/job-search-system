    ...
    <div style={{ minHeight: "100vh", background: "#F8FAFC", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 32px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 36 }}>
          ...
          <div>
            <div style={{ fontSize: 17, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.02em", lineHeight: 1.2 }}>{fullName}</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 40 }}>
          {[
            ...
            },
            {
              ...
              description: isPaid
                ? "Manage your plan, or cancel your subscription."
            ...
            <Link
              key={item.href}
              href={item.href}
              style={{ display: "flex", alignItems: "center", gap: 16, padding: "18px 20px", background: "#fff", borderRadius: 16, border: "1px solid #E2E8F0", textDecoration: "none" }}
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 13, color: "#64748B", lineHeight: 1.5 }}>{item.description}</div>
              </div>
        ...
        {/* Danger zone */}
        <div style={{ padding: "20px 24px", background: "#fff", borderRadius: 16, border: "1px solid rgba(239,68,68,0.2)" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap" as const, gap: 12 }}>
            <div>
              <div style={{ fontSize: 14, fontWeight: 600, color: "#0F172A" }}>Delete account</div>
              <div style={{ fontSize: 13, color: "#64748B", marginTop: 2, maxWidth: 400, lineHeight: 1.5 }}>
