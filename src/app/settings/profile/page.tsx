  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F8FAFC", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 620, margin: "0 auto", padding: "40px 32px" }}>
        <h1 style={{ fontSize: 22, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.03em", margin: "0 0 6px" }}>Profile settings</h1>
        <p style={{ fontSize: 14, color: "#64748B", margin: "0 0 32px" }}>Update your name and change your password.</p>
