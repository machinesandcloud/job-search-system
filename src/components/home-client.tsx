...
const PEOPLE = [
  { name:"Marcus J.",    role:"Backend Eng → Staff Eng",    photo:"/avatars/36.jpg",   color1:"#4361EE", color2:"#818CF8", initials:"MJ", quote:"I'd been a Senior for 4 years. Zari helped me build the case — scope, impact, sponsorship. Got promoted in 5 months.", stars:5, tag:"Promotion" },
  { name:"Priya M.",     role:"PM → Senior PM at Notion",   photo:"/avatars/1.jpg", color1:"#7C3AED", color2:"#A78BFA", initials:"PM", quote:"The resume feedback was specific to the point of being uncomfortable — it knew exactly what was wrong.", stars:5, tag:"Resume" },
  { name:"Aaliyah R.",   role:"Data Scientist → Stripe",    photo:"/avatars/2.jpg", color1:"#0284C7", color2:"#38BDF8", initials:"AR", quote:"The LinkedIn session rebuilt my headline and I got 3 recruiter DMs the same week.", stars:5, tag:"LinkedIn" },
  { name:"Daniel K.",    role:"Ops Lead → Shopify PM",      photo:"/avatars/37.jpg",   color1:"#059669", color2:"#34D399", initials:"DK", quote:"4 callbacks in 1 week after one resume session. The bullet rewrites were shockingly specific.", stars:5, tag:"Job Search" },
  { name:"Sofia L.",     role:"IC → Engineering Manager",   photo:"/avatars/3.jpg", color1:"#DC2626", color2:"#F87171", initials:"SL", quote:"I used Zari to practice my manager pitch. It pushed back hard on weak answers. Felt completely ready for the real conversation.", stars:5, tag:"Promotion" },
  { name:"James T.",     role:"Director → VP Engineering",  photo:"/avatars/38.jpg",   color1:"#D97706", color2:"#FCD34D", initials:"JT", quote:"Zari helped me build executive presence in my communication. My skip-level feedback changed noticeably.", stars:5, tag:"Leadership" },
  { name:"Camille D.",   role:"Finance → Stripe PM",        photo:"/avatars/4.jpg", color1:"#7C3AED", color2:"#C4B5FD", initials:"CD", quote:"Career change from finance to product. Zari reframed my entire narrative. Without it I'd still be sending unanswered applications.", stars:5, tag:"Career Change" },
  { name:"Ryan O.",      role:"Sales Lead → Google APM",    photo:"/avatars/39.jpg",   color1:"#0284C7", color2:"#7DD3FC", initials:"RO", quote:"Zari ran the salary negotiation with me until it stopped feeling scary. Walked away with $28K more than the first offer.", stars:5, tag:"Negotiation" },
];
...
const FOUNDERS = [
  {
    ...
    story1: `"I spent years watching talented people get passed over — not because they lacked ability, but because they couldn't tell their story. As a Tech Leader, hiring manager, and career advisor, I saw the same pattern repeat: vague bullets, weak interview stories, salary negotiations abandoned too early.`,
