...
const toneMap: Record<Tone, { pill: string; ring: string; glow: string; bar: string }> = {
  ...
  cyan: {
    pill: "border-[color:var(--ca-pill-cyan-bd)] bg-[var(--ca-pill-cyan-bg)] text-[color:var(--ca-pill-cyan-text)]",
    ring: "border-sky-400/20",
    glow: "from-sky-400/16 via-blue-400/10 to-transparent",
    bar: "from-sky-300 via-blue-400 to-indigo-400",
  },
  gold: {
    pill: "border-[color:var(--ca-pill-gold-bd)] bg-[var(--ca-pill-gold-bg)] text-[color:var(--ca-pill-gold-text)]",
    ring: "border-amber-400/20",
    glow: "from-amber-400/18 via-orange-400/10 to-transparent",
    bar: "from-amber-300 via-orange-400 to-rose-400",
  },
  rose: {
    pill: "border-[color:var(--ca-pill-rose-bd)] bg-[var(--ca-pill-rose-bg)] text-[color:var(--ca-pill-rose-text)]",
  ...
  emerald: {
    pill: "border-[color:var(--ca-pill-em-bd)] bg-[var(--ca-pill-em-bg)] text-[color:var(--ca-pill-em-text)]",
